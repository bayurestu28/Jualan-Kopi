@extends('layouts.guest.app',['tittle' => 'Coffee Shop | 100% Kualitas Terbaik'])
			...
			<div class="row">
				...
				<div class="col text-justify">
					<p class="my-5">
						...
						<b>1</b>. Mempertahankan cita rasa kopi yang sudah melegenda secara turun-temurun. <br>
						<b>2</b>. Meningkatkan kreativitas untuk menciptakan menu-menu baru yang lebih bervariatif untuk dapat ditawarkan dan dinikmati oleh pelanggan. <br>
						<b>3</b>. Menawarkan kenyamanan di dalam menikmati kopi kepada pelanggan. <br>
					</p>
				</div>
			</div>
		</div>
				...
				<div class="container rounded pt-2">
					<form action="{{ route('register.request') }}" method="POST" enctype="multipart/form-data" autocomplete="off" class="was-validated">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="no_telp" placeholder="Masukkan nomor telepon anda" required="" maxlength="12" min="9999999999" max="999999999999">
							<div class="invalid-feedback">
