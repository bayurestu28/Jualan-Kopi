                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div>
                        <ul class="navbar-nav mr-auto btn">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#link-produk">Produk</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#link-tentang">Tentang Web</a>
                            </li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right text-center" aria-labelledby="navbarDropdown" style="background-color: #DAD2C8;">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="fas fa-tasks"></i> Riwayat Transaksi</a>
                                        <a class="dropdown-item" href="#"><i class="fas fa-shopping-cart"></i> Keranjang</a>
