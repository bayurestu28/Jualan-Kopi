@extends('layouts.admin.app', ['title' => 'My Profile | Coffee Shop'])
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal text-justify" method="post" action="{{ route('admin.myprofile.update',Auth::user()->id) }}" enctype="multipart/form-data" autocomplete="off">
                  @csrf
